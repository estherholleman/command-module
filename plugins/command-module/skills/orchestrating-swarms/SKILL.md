...
From the `command-module` plugin (examples):

### Review Agents
```javascript
// Security review
Task({
  subagent_type: "command-module:review:security-sentinel",
...
// Performance review
Task({
  subagent_type: "command-module:review:performance-oracle",
...
// Rails code review
Task({
  subagent_type: "command-module:review:kieran-rails-reviewer",
...
// Architecture review
Task({
  subagent_type: "command-module:review:architecture-strategist",
...
// Code simplicity
Task({
  subagent_type: "command-module:review:code-simplicity-reviewer",
  description: "Simplicity check",
  prompt: "Check if this implementation can be simplified"
})
```

**All review agents from command-module:**
...
Task({
  subagent_type: "command-module:research:best-practices-researcher",
...
Task({
  subagent_type: "command-module:research:framework-docs-researcher",
...
Task({
  subagent_type: "command-module:research:git-history-analyzer",
...
```javascript
Task({
  subagent_type: "command-module:design:figma-design-sync",
...
```javascript
Task({
  subagent_type: "command-module:workflow:bug-reproduction-validator",
