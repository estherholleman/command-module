---
name: work-beta
description: "[BETA] Execute work plans with external delegate support. Same as work but includes experimental Codex delegation mode for token-conserving code implementation."
...
- A plan implementation unit contains `Execution target: external-delegate` in its Execution note (set by implementation-plan)
