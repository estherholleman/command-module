...
1. **Read Plan and Clarify**
   ...
   - If the plan defers work to a future version, a different repo, or a conditional trigger, classify each deferred item by flavor (same-repo code-triggered / same-repo condition-triggered / cross-repo) and record it in that flavor's primary home — a code-level grep-findable marker, a task with trigger description, or a task whose body is a self-contained execution prompt. See `docs/solutions/skill-design/deferring-work-three-flavors-*.md` for the full pattern. If execution surfaces *new* deferred items the plan didn't anticipate, apply the same classification before adding them as TODO comments — a TODO alone is rarely the right home
...
3. **Create Pull Request**
   ...
   [![Compound Engineering v[VERSION]](https://img.shields.io/badge/Compound_Engineering-v[VERSION]-6366f1)](https://github.com/EveryInc/command-module-plugin)
