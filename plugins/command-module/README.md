...
| `/tutor` | Patient, expository learning companion for external topics; teaches tuned to a durable learner profile and treats deep research as a deliberate, always-ask anchor |
