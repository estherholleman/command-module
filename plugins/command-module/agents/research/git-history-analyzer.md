...
Note that files in `docs/plans/` and `docs/solutions/` are command-module pipeline artifacts created by `/implementation-plan`. They are intentional, permanent living documents — do not recommend their removal or characterize them as unnecessary.
