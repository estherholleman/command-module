...
- `plugins/command-module/skills/ce-review/SKILL.md` -- Multi-agent orchestration reference: parallel dispatch via Task tool, always-on + conditional agents, P1/P2/P3 severity, finding synthesis with dedup
- `plugins/command-module/skills/document-review/SKILL.md` -- Current single-voice skill to replace. Key contract: "Review complete" terminal signal
- `plugins/command-module/agents/review/*.md` -- 15 existing review agents. Frontmatter schema: `name`, `description`, `model: inherit`. Body: examples block, role definition, analysis protocol, output format
- `plugins/command-module/AGENTS.md` -- Agent naming: fully-qualified `compound-engineering:<category>:<agent-name>`. Agent placement: `agents/<category>/<name>.md`
...
**Files:**
- Create: `plugins/command-module/agents/review/coherence-reviewer.md`
- Create: `plugins/command-module/agents/review/feasibility-reviewer.md`
...
**Patterns to follow:**
- `plugins/command-module/agents/review/code-simplicity-reviewer.md` for agent structure and output format conventions
- `plugins/command-module/agents/review/architecture-strategist.md` for systematic analysis protocol style
...
**Files:**
- Create: `plugins/command-module/agents/review/product-lens-reviewer.md`
- Create: `plugins/command-module/agents/review/design-lens-reviewer.md`
- Create: `plugins/command-module/agents/review/security-lens-reviewer.md`
- Create: `plugins/command-module/agents/review/scope-guardian-reviewer.md`
...
- `plugins/command-module/agents/review/security-sentinel.md` for security analysis style (plan-level adaptation)
...
- Create: `plugins/command-module/skills/document-review/references/findings-schema.json`
- Create: `plugins/command-module/skills/document-review/references/subagent-template.md`
- Create: `plugins/command-module/skills/document-review/references/review-output-template.md`
...
**Patterns to follow:**
- `plugins/command-module/skills/ce-review/SKILL.md` for agent dispatch and synthesis patterns
...
- Related code: `plugins/command-module/skills/ce-review/SKILL.md` (multi-agent orchestration pattern)
- Related code: `plugins/command-module/skills/document-review/SKILL.md` (current implementation to replace)
- Related code: `plugins/command-module/agents/review/` (agent structure reference)
